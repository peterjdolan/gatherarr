...
class HistoryResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[HistoryResource] | None | Unset):
  """
  ...
  records: list[HistoryResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[HistoryResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        pass
      return cast(list[HistoryResource] | None | Unset, data)
