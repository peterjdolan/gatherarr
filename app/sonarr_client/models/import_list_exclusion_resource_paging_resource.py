...
class ImportListExclusionResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[ImportListExclusionResource] | None | Unset):
  """
  ...
  records: list[ImportListExclusionResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[ImportListExclusionResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
