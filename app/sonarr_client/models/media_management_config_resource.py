...
class MediaManagementConfigResource:
  ...
  Attributes:
      ...
      episode_title_required (EpisodeTitleRequiredType | Unset):
  ...
  id: int | Unset = UNSET
  auto_unmonitor_previously_downloaded_episodes: bool | Unset = UNSET
  ...
  create_empty_series_folders: bool | Unset = UNSET
  ...
  episode_title_required: EpisodeTitleRequiredType | Unset = UNSET
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    episode_title_required: str | Unset = UNSET
