...
def _get_kwargs(
  *,
  ...
  include_series: bool | Unset = UNSET,
  include_episode: bool | Unset = UNSET,
  event_type: list[int] | Unset = UNSET,
  episode_id: int | Unset = UNSET,
...
def sync_detailed(
  *,
  ...
  Args:
      ...
      include_series (bool | Unset):
      include_episode (bool | Unset):
      event_type (list[int] | Unset):
      episode_id (int | Unset):
