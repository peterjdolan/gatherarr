...
class CustomFormatSpecificationSchema:
  ...
  Attributes:
      ...
      presets (list[CustomFormatSpecificationSchema] | None | Unset):
  """
  ...
  presets: list[CustomFormatSpecificationSchema] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_presets(data: object) -> list[CustomFormatSpecificationSchema] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
