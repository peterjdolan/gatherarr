...
class BlocklistResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[BlocklistResource] | None | Unset):
  """
  ...
  records: list[BlocklistResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[BlocklistResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        pass
      return cast(list[BlocklistResource] | None | Unset, data)
