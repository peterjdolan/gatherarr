...
class ImportListExclusionResource:
  ...
  Attributes:
      ...
      presets (list[ImportListExclusionResource] | None | Unset):
      tmdb_id (int | Unset):
      movie_title (None | str | Unset):
      movie_year (int | Unset):
  """
  ...
  presets: list[ImportListExclusionResource] | None | Unset = UNSET
  tmdb_id: int | Unset = UNSET
  movie_title: None | str | Unset = UNSET
  movie_year: int | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_presets(data: object) -> list[ImportListExclusionResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        for presets_type_0_item_data in _presets_type_0:
          presets_type_0_item = ImportListExclusionResource.from_dict(presets_type_0_item_data)
        ...
        pass
      return cast(list[ImportListExclusionResource] | None | Unset, data)
