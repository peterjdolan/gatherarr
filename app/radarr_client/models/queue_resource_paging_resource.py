...
class QueueResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[QueueResource] | None | Unset):
  """
  ...
  records: list[QueueResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[QueueResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        pass
      return cast(list[QueueResource] | None | Unset, data)
