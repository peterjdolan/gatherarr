...
class DownloadClientConfigResource:
  ...
  Attributes:
      ...
      check_for_finished_download_interval (int | Unset):
  ...
  check_for_finished_download_interval: int | Unset = UNSET
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    if check_for_finished_download_interval is not UNSET:
      field_dict["checkForFinishedDownloadInterval"] = check_for_finished_download_interval
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    check_for_finished_download_interval = d.pop("checkForFinishedDownloadInterval", UNSET)
