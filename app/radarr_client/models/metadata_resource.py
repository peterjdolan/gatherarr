...
class MetadataResource:
  ...
  Attributes:
      ...
      presets (list[MetadataResource] | None | Unset):
      enable (bool | Unset):
  """
  ...
  presets: list[MetadataResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_presets(data: object) -> list[MetadataResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        pass
      return cast(list[MetadataResource] | None | Unset, data)
