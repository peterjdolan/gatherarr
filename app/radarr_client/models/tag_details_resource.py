...
class TagDetailsResource:
  ...
  Attributes:
      ...
      release_profile_ids (list[int] | None | Unset):
  ...
  release_profile_ids: list[int] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_release_profile_ids(data: object) -> list[int] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
    ...
    release_profile_ids = _parse_release_profile_ids(d.pop("releaseProfileIds", UNSET))
