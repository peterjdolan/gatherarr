...
class MovieResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[MovieResource] | None | Unset):
  """
  ...
  records: list[MovieResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[MovieResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        for records_type_0_item_data in _records_type_0:
          records_type_0_item = MovieResource.from_dict(records_type_0_item_data)
        ...
        pass
      return cast(list[MovieResource] | None | Unset, data)
