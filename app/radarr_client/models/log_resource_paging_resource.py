...
class LogResourcePagingResource:
  ...
  Attributes:
      ...
      records (list[LogResource] | None | Unset):
  """
  ...
  records: list[LogResource] | None | Unset = UNSET
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_records(data: object) -> list[LogResource] | None | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        ...
        pass
      return cast(list[LogResource] | None | Unset, data)
